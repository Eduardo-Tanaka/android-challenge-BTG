...
import br.com.eduardotanaka.btgchallenge.util.DateTimeUtil
import com.bumptech.glide.Glide
import java.util.*
import kotlin.collections.ArrayList

class FilmeFavoritoListAdapter(
    var filmes: List<FilmePopular>,
    val context: Context
) : RecyclerView.Adapter<FilmeFavoritoListAdapter.MainViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FilmeFavoritoListAdapter.MainViewHolder {
        val itemBinding =
            LayoutFilmePopularBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MainViewHolder(itemBinding)
    }

    override fun onBindViewHolder(holder: FilmeFavoritoListAdapter.MainViewHolder, position: Int) {
    ...
    inner class MainViewHolder(private val rowView: LayoutFilmePopularBinding) :
        ...
        fun bind(filme: FilmePopular) {
            ...
            rowView.cardFilmeData.text = this.filme.data.format(DateTimeUtil.defaultFormatter)
